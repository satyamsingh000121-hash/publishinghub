        ...
        <div className="w-full lg:w-[48%] relative min-h-[380px] sm:min-h-[420px] flex flex-col justify-between">
          ...
          <div className="relative w-full h-[320px] sm:h-[340px]">
            ...
            >
              ...
              <div className="font-display text-5xl sm:text-6xl md:text-7xl lg:text-[84px] font-normal leading-[0.93] tracking-[-0.025em] text-[#f2eee3]">
                <SmokyText
                ...
                />
                <div className="mt-1 text-[#d4b56a]">
                  <SmokyText
              ...
              <div className="flex flex-wrap items-center gap-4 pt-4">
                <a
                  href="#bestsellers"
                  className="min-h-[50px] px-10 bg-[#2c7650] hover:bg-[#37865d] text-white text-[12px] font-bold tracking-[0.14em] uppercase inline-flex items-center justify-center transition-all duration-300 hover:-translate-y-0.5 shadow-lg shadow-[#123d2b]/40 rounded-sm"
                >
                  PURCHASE
                </a>
                <a
                  href="#featured"
                  className="min-h-[50px] px-9 border border-[#f2eee3]/30 hover:border-[#d4b56a] text-[#f2eee3] hover:text-[#d4b56a] text-[12px] font-bold tracking-[0.12em] uppercase inline-flex items-center justify-center transition-all duration-300 hover:-translate-y-0.5 bg-black/20 rounded-sm"
                >
                  EXPLORE BOOKS
                </a>
              </div>
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-4 pt-4">
                <a
                  href="#bestsellers"
                  className="min-h-[50px] px-9 bg-[#2c7650] hover:bg-[#37865d] text-white text-[12px] font-bold tracking-[0.12em] uppercase inline-flex items-center justify-center transition-all duration-300 hover:-translate-y-0.5 shadow-lg shadow-[#123d2b]/40 rounded-sm"
                >
                  SHOP NOW
                </a>
                <a
                  href="#featured"
                  className="min-h-[50px] px-8 border border-[#f2eee3]/30 hover:border-[#d4b56a] text-[#f2eee3] hover:text-[#d4b56a] text-[12px] font-bold tracking-[0.12em] uppercase inline-flex items-center justify-center transition-all duration-300 hover:-translate-y-0.5 bg-black/20 rounded-sm"
                >
                  VIEW COLLECTION
                </a>
              </div>
            ...
            >
              <div className="relative w-full h-full flex items-center justify-center overflow-visible">
                <img
                  ...
                  className="w-full h-full max-h-[420px] sm:max-h-[460px] lg:max-h-[490px] object-contain dark:drop-shadow-[0_25px_50px_rgba(0,0,0,0.95)] drop-shadow-[0_12px_24px_rgba(147,51,234,0.14)] transform scale-100 hover:scale-105 transition-transform duration-700"
                />
              </div>
            </div>
