...
const ALL_SHOP_BOOKS: BookItem[] = [
  ...
  },
  {
    ...
    description: "Heartfelt verses and serene poetry reflecting on the sublime beauty of our natural world.",
  },
  {
    id: "shop-22",
    ...
    description: "An evocative collection of contemplative verse exploring silence and emotional resonance.",
  },
];
