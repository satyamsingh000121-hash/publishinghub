...
export default function AboutIntro() {
  return (
    <section className="py-20 sm:py-28 dark:bg-[#060a08] bg-white relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-16 max-w-5xl mx-auto">
          ...
          <div className="flex-1 text-center lg:text-left max-w-3xl px-2">
            <blockquote className="font-display italic text-3xl sm:text-4xl md:text-5xl lg:text-[42px] xl:text-[46px] font-normal dark:text-[#f2eee3] text-[#18181b] leading-[1.26] tracking-tight mb-8">
            ...
            <div className="flex items-center justify-center lg:justify-start gap-3 text-[#d4b56a] opacity-95 pt-4 sm:pt-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="w-3 h-3 rotate-45 border border-[#d4b56a] dark:bg-[#060a08] bg-white flex items-center justify-center">
