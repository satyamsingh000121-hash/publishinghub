      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
          ...
          <div className="md:col-span-5 aspect-[3/4] bg-[#070c09] border border-[#f2eee3]/10 overflow-hidden relative shadow-xl">
            {displayBadge && (
              <span className="absolute top-2 left-2 z-20 bg-[#2c7650] text-white text-[8px] font-bold px-2 py-0.5 uppercase">
          ...
          <div className="md:col-span-7 space-y-4">
            ...
            <div className="pt-2 flex items-center gap-3">
              <button
                ...
                className="flex-1 min-h-[44px] bg-[#2c7650] hover:bg-[#37865d] text-white text-xs font-bold tracking-wider uppercase inline-flex items-center justify-center gap-2 transition-colors rounded-[2px]"
              >
