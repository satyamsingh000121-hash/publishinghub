    ...
    <div className="fixed inset-0 z-50 overflow-hidden animate-in fade-in duration-200">
      ...
      <div className="absolute inset-y-0 right-0 max-w-full flex pl-0 sm:pl-10">
        <div className="w-full sm:w-screen sm:max-w-md bg-white dark:bg-[#070d0a] border-l border-[#e9e1f5] dark:border-[#d4b56a]/30 shadow-2xl p-5 sm:p-6 flex flex-col justify-between text-[#18181b] dark:text-[#f2eee3]">
          ...
          <div>
            <div className="flex items-center justify-between pb-4 border-b border-[#e9e1f5] dark:border-[#f2eee3]/10">
              <div className="flex items-center gap-2">
                <ShoppingBag className="w-5 h-5 text-[#9333ea] dark:text-[#d4b56a]" />
                <h3 className="font-display text-xl font-medium text-[#18181b] dark:text-[#f2eee3]">Your Cart</h3>
              </div>
          ...
          {/* Footer Checkout */}
          {items.length > 0 && (
            <div className="border-t border-[#e9e1f5] dark:border-[#f2eee3]/10 pt-4 space-y-4">
              ...
              <button
                ...
                className="w-full min-h-[46px] bg-[#9333ea] hover:bg-[#7e22ce] dark:bg-[#2c7650] dark:hover:bg-[#37865d] text-white text-xs font-bold tracking-wider uppercase flex items-center justify-center gap-2 transition-colors rounded-[2px] shadow-md cursor-pointer"
              >
